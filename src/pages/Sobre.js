...
import videoApresentação from '../imgs/Apresentação time da empresa moderno simples colorido vermelho amarelo e preto.mp4'
...
const Sobre = () => {
    return (
        ...
        <div className="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4 mt-28 mb-2">
            <Link to={"/"} className="font-normal text-sm leading-3 mb-7 text-gray-900 hover:text-gray-400 cursor-pointer pb-2">Voltar a Home</Link>
            <div className="flex lg:flex-row flex-col lg:gap-8 sm:gap-10 gap-12">
                <div className="w-full lg:w-6/12">
                    <h2 className="w-full font-bold lg:text-4xl text-3xl lg:leading-10 leading-9">TopToys</h2>
                    <p className="font-normal text-base leading-6 text-gray-900 mt-6">TopToys, e um ecommerce online cujo intuito é fornecer praticidade, conforto e lazer. Nosso ecommerce hoje está voltado para o mercado de brinquedos e eletrônicos. Prezado sempre pela segurança do cliente ao realizar sua compra e atendimento.</p>
                </div>
                <div className="w-full lg:w-6/12">
            ...
            <div className="grid sm:grid-cols-3 grid-cols-2 sm:gap-8 gap-4">
                <div>
                    <p className="font-semibold lg:text-2xl text-xl lg:leading-6 leading-5 text-gray-900 mt-6">Fundação</p>
                    <p className="font-normal text-base leading-6 text-gray-600 mt-6">Topys teve seu início no ano de 2015, contando hoje com mais de 8 anos de história desde seu início.</p>
                </div>
                <div>
                    <p className="font-semibold lg:text-2xl text-xl lg:leading-6 leading-5 text-gray-800 mt-6">Politicas do usúario </p>
                    <p className="font-normal text-base leading-6 text-gray-600 mt-6">Nossa empresa preserva sempre os valores, do respeito mutuo. Hoje contamos com mais 200 colaboradores para tirar dúvidas e atender o cliente da melhor maneira possível</p>
                </div>
                <div className="sm:block hidden">
                    <p className="font-semibold lg:text-2xl text-xl lg:leading-6 leading-5 text-gray-800 mt-6">50k Usuários</p>
                    <p className="font-normal text-base leading-6 text-gray-600 mt-6">Hoje a nosso ecommerce conta com mais de 50 mil usuários cadastrados.</p>
                </div>
            </div>
            ...
            <div className="flex lg:flex-row flex-col md:gap-14 gap-16 justify-between lg:mt-20 mt-16">
                <div className="w-full lg:w-6/12">
                   <video src={videoApresentação} controls></video>
                </div>
                <div className="w-full lg:w-6/12 ">
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 lg:gap-12 gap-10">
                        {/* <!-- Team Card --> */}
                        <div className="flex p-4 shadow-md hover:scale-105 ">
                            <div className="mr-6">
                            ...
                            <div className="">
                                <p className="font-semibold lg:text-2xl text-xl lg:leading-6 leading-5 text-gray-800">Time</p>
                                <p className="mt-2 font-normal text-base leading-6 text-gray-600">Deseja trabalhar conosco ? Clique e veja nossas vagas</p>
                            </div>
                        </div>
                        ...
                        <div className="flex p-4 shadow-md hover:scale-105">
                            ...
                            <div className="">
                                <p className="font-semibold lg:text-2xl text-xl lg:leading-6 leading-5 text-gray-800">Cadastra-se</p>
                                <p className="mt-2 font-normal text-base leading-6 text-gray-600">Ainda não tem cadastro ? clique aqui para se cadastrar.</p>
                            </div>
                        </div>
                        ...
                        <div className="flex p-4 shadow-md hover:scale-105">
                            ...
                            <div className="">
                                ...
                                <p className="mt-2 font-normal text-base leading-6 text-gray-600">Em caso de dúvidas reclamações ou sugestões entre em contato conosco que nossos especialista iram te responder.</p>
                            </div>
                        </div>
                    </div>
                </div>
