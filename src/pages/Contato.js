      ...
      <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
        ...
        <Link to={"/"} className="font-normal text-sm leading-3 mb-7 text-gray-900 hover:text-gray-400 cursor-pointer pb-2">Voltar a Home</Link>
          ...
          <p className="text-body-color mb-9 text-base leading-relaxed">
           Nosso time tem uma média de respota de até 2 horas, confiram sempre sua caixa de spam.
          </p>
          <div className="mb-8 flex w-full max-w-[370px]">
            ...
            <div className="w-full">
              <h4 className="text-dark mb-1 text-xl font-bold">Localização</h4>
              <p className="text-body-color text-base">
                Rua Vinicius Degani 223
              </p>
            </div>
          </div>
          <div className="mb-8 flex w-full max-w-[370px]">
            ...
            <div className="w-full">
              <h4 className="text-dark mb-1 text-xl font-bold">SAC</h4>
              <p className="text-body-color text-base">(+55)0800 940 1331</p>
            </div>
          </div>
          <div className="mb-8 flex w-full max-w-[370px]">
            <div
            ...
            <div className="w-full">
              <h4 className="text-dark mb-1 text-xl font-bold">Email de Contato</h4>
              <p className="text-body-color text-base">TopToys@gmail.com</p>
            </div>
          </div>
        </div>
      </div>
      <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
        <div className="relative rounded-lg bg-white p-8 shadow-lg sm:p-12">
          <form onSubmit={handleSubmit}>
            ...
            <div>
            {isLoading ? <p className='text-center text-gray-900 border-primary'>...Enviando Formulário</p> :  <button
